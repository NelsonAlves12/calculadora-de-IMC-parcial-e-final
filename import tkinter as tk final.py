# autor: Nelson Alves
# data: 13.11.2024
# código: calculadora de IMC (final)
...
def calcular_imc():
    try:
        ...
        resultado_label.config(text=f"{nome1}: IMC = {imc1:.2f} ({categoria1})\n"
                               f"{nome2}: IMC = {imc2:.2f} ({categoria2})\n"
                               f"{nome3}: IMC = {imc3:.2f} ({categoria3})")
    except ValueError:
...
# Labels e entradas para nome, peso e altura das 3 pessoas
tk.Label(janela, text="Nome Pessoa 1:", bg='#f0f8ff', fg='#000080',
         font=('Arial', 12)).grid(row=0, column=0, padx=10, pady=10)
entry_nome1 = tk.Entry(janela)
entry_nome1.grid(row=0, column=1, padx=10, pady=10)
...
entry_peso1.grid(row=1, column=1, padx=10, pady=10)
...
entry_altura1.grid(row=2, column=1, padx=10, pady=10)

tk.Label(janela, text="Nome Pessoa 2:", bg='#f0f8ff', fg='#000080',
         font=('Arial', 12)).grid(row=3, column=0, padx=10, pady=10)
entry_nome2 = tk.Entry(janela)
entry_nome2.grid(row=3, column=1, padx=10, pady=10)
...
entry_peso2.grid(row=4, column=1, padx=10, pady=10)
...
entry_altura2.grid(row=5, column=1, padx=10, pady=10)

tk.Label(janela, text="Nome Pessoa 3:", bg='#f0f8ff', fg='#000080',
         font=('Arial', 12)).grid(row=6, column=0, padx=10, pady=10)
entry_nome3 = tk.Entry(janela)
entry_nome3.grid(row=6, column=1, padx=10, pady=10)
...
entry_peso3.grid(row=7, column=1, padx=10, pady=10)

tk.Label(janela, text="Altura Pessoa 3 (m):", bg='#f0f8ff', fg='#000080',
         font=('Arial', 12)).grid(row=8, column=0, padx=10, pady=10)
entry_altura3 = tk.Entry(janela)
entry_altura3.grid(row=8, column=1, padx=10, pady=10)
...
botao_calcular.grid(row=9, column=0, columnspan=2, padx=10, pady=10)
